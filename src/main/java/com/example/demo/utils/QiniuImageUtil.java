...
public class QiniuImageUtil {
    ...
    // 要上传的空间
    private static final String bucketname = "ljafinalimage";
...
//    UploadManager uploadManager = new UploadManager(cfg);
    ...
    // 测试域名，只有30天有效期
    private static String QINIU_IMAGE_DOMAIN = "http://rb8v8q2nr.hn-bkt.clouddn.com/";
...
//            logger.error("七牛异常:" + e.getMessage());
     ...
     * 删除七牛云上ljavideo上的文件
     */
    public int deleteImageFromQiniu(String fileName){
